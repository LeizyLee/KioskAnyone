...
a_label = ttk.Label(UpFrame, text="-1", anchor="center", font=Afont, width=8)
a_label.grid(column=0, row=0, sticky='w')
b_label = ttk.Label(UpFrame, text="0", anchor="center", font=Bfont, width=8)
b_label.grid(column=1, row=0,sticky='w')
c_label = ttk.Label(UpFrame, text="1", anchor="center", font=Afont, width=8)
